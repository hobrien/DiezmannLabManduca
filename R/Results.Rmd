...
weight_25_versus_30C <- read_tsv(ffDataFolder("25_versus_30_weight.txt"))
...
ggsave(ffPanelFolder("Fig.S1_weight_temperature.pdf"), plot=weight_temperature, height=2.5, width=8, units="in")
```
