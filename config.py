lookup = {
    ('candida_genome'):
        ('ftp://ftp.ensemblgenomes.org/pub/fungi/release-37/fasta/fungi_ascomycota2_collection/candida_albicans_sc5314/dna/'
         'Candida_albicans_sc5314.Cand_albi_SC5314_V4.dna.toplevel.fa.gz'),
    ('candida_gff'):
